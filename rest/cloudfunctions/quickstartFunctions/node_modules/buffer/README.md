...
With [browserify](browserify.org), simply `require('buffer')` or use the `Buffer` global and you will get this module.
...
[browserify](browserify.org) and this module will automatically be included
...
MIT. Copyright (C) [Feross Aboukhadijeh](feross.org), and other contributors. Originally forked from an MIT-licensed module by Romain Beauxis.
