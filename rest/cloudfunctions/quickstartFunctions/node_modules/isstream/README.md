...
[![Build Status](https://secure.travis-ci.org/rvagg/isstream.png)](travis-ci.org/rvagg/isstream)
...
*Reminder: when implementing your own streams, please [use **readable-stream** rather than core streams](r.va.gg/2014/06/why-i-dont-use-nodes-core-stream-module.html).*
