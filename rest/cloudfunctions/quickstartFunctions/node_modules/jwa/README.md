...
A
[JSON Web Algorithms](tools.ietf.org/id/draft-ietf-jose-json-web-algorithms-08.html)
implementation focusing (exclusively, at this point) on the algorithms necessary for
[JSON Web Signatures](self-issued.info/docs/draft-ietf-jose-json-web-signature.html).
...
Output [base64url](en.wikipedia.org/wiki/Base64#URL_applications)
