...
Port of [TweetNaCl](tweetnacl.cr.yp.to) / [NaCl](nacl.cr.yp.to/)
...
Implements [ed25519](ed25519.cr.yp.to).
...
* [tweetnacl-auth-js](https://github.com/dchest/tweetnacl-auth-js) — implementation of [`crypto_auth`](nacl.cr.yp.to/auth.html)
