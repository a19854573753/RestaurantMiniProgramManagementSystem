...
[![Build Status](https://secure.travis-ci.org/kpdecker/jsdiff.svg)](travis-ci.org/kpdecker/jsdiff)
[![Sauce Test Status](https://saucelabs.com/buildstatus/jsdiff)](https://saucelabs.com/u/jsdiff)

A javascript text differencing implementation.

Based on the algorithm proposed in
["An O(ND) Difference Algorithm and its Variations" (Myers, 1986)](citeseerx.ist.psu.edu/viewdoc/summary?doi=10.1.1.4.6927).
...
**[Full online demo](kpdecker.github.com/jsdiff)**
