...
This module has utilities for URL resolution and parsing meant to have feature parity with node.js core [url](nodejs.org/api/url.html) module.
...
* `href`: The full URL that was originally parsed. Both the protocol and host are lowercased.
    ...
    Example: `'user:pass@host.com:8080/p/a/t/h?query=string#hash'`
