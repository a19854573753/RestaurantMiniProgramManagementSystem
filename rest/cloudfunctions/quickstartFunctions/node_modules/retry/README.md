...
<!-- badges/ -->
[![Build Status](https://secure.travis-ci.org/tim-kos/node-retry.png?branch=master)](travis-ci.org/tim-kos/node-retry "Check this project's build status on TravisCI")
...
<www.wolframalpha.com/input/?i=Sum%5B1000*x^k%2C+{k%2C+0%2C+9}%5D+%3D+5+*+60+*+1000>

[article]: dthain.blogspot.com/2009/02/exponential-backoff-in-distributed.html
